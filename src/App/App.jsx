...
const loadPicture = ({ dispatch }) => {
  dispatch({
    type: 'LOAD_PICTURE',
    payload: `https://picsum.photos/800/600/?random&_t=${new Date().getTime()}`,
  })
}
...
const App = () => {
  ...
  return (
    <>
      ...
      <Button onClick={doLoadPicture} disabled={btnDisabled}>
        Load from web
      </Button>

      <Upload onComplete={doUploadPicture} disabled={btnDisabled}>
        Upload from device
      </Upload>
    </>
  )
